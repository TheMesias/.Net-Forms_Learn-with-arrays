...
{
    public partial class FormTreintaYTres : Form
    {
        int filasYcolumnas;
        int f = 0;
        int c = 0;
        int[,] arreglo = new int[10, 10];
        public FormTreintaYTres()
        {
            InitializeComponent();
        }
        ...
        public void ProcesMayorDiag()
        {
            ClTreintaYTres Obj1 = new ClTreintaYTres(arreglo);
            lbl_respuesta.Text = Obj1.numDiagSuperior(filasYcolumnas).ToString(); 
        }
